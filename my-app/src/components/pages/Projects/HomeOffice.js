...
export default function HomeOffice() {
  return (
    <div>
      <br></br>
      <h1 className="title-font">NY HOME OFFICE</h1>
      <br></br>
      <div class="container text-center">
        <div class="row">
          <div class="col">
            <p className="paragraph-font" id="cad-text">INT 175 - CUSTOM DESIGN</p>
            <p className="paragraph-font" id="cad-text">COMPLETED FEB 16, 2023</p>
      ...
      <div class="container text-center">
        ...
        <div class="row">
          ...
          <div class="col-4" id="intro-text">
            <br></br>
            <h2 className="title-font">PRELIMINARY SKETHCES</h2>
            <br></br>
